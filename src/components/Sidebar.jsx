function Sidebar({ activeSection, scrollToSection }) {
  return (
    <>
      {/* Sidebar */}
      <aside
        className="w-full lg:fixed lg:left-6 md:lg:left-8 lg:top-0 lg:h-screen lg:w-80 bg-transparent p-6 md:p-10 flex flex-col z-40"
      >
        {/* Name and Title */}
        ...
        <div className="mt-auto mb-8">
          <div className="flex space-x-3 mb-8">
            ...
            <a
              href="mailto:tommycomeau28@gmail.com"
              className="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-all duration-200"
              aria-label="Email"
            >
