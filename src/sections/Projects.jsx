...
function Projects() {
  ...
  const projects = [
    {
      title: 'Workout Social',
      description: 'A full-stack social fitness application that allows users to log workouts, track exercises, and share their fitness journey with others. Built with React Native (Expo) for mobile and Node.js/Express for the backend.',
      technologies: ['React Native', 'TypeScript', 'Node.js', 'Express.js', 'PostgreSQL', 'JWT'],
      github: 'https://github.com/tommycomeau3/workout-social',
      live: 'https://github.com/tommycomeau3/workout-social',
      image: '/images/social-logo.png',
      details: 'Built a comprehensive social fitness platform with cross-platform mobile app (iOS/Android) and RESTful API backend. Features include user authentication with JWT, workout logging with detailed set tracking, exercise library with muscle group categorization, social features (follow users, like workouts, comments), progress tracking with analytics, and real-time feed updates. The mobile app uses React Navigation for seamless tab navigation and includes custom SVG charts for progress visualization.',
      features: ['Cross-Platform Mobile App', 'User Authentication', 'Workout Logging', 'Social Features', 'Exercise Analytics', 'Progress Tracking', 'RESTful API'],
    },
    {
      ...
      github: 'https://github.com/tommycomeau3/ufc-prediction-2',
      live: 'https://github.com/tommycomeau3/ufc-prediction-2',
    ...
    {
      title: 'WorkoutWizard',
      description: 'A web application where users enter specifications about their intended workout and receive an AI-generated workout routine based on those specifications.',
      technologies: ['HTML', 'JavaScript', 'CSS', 'AI'],
      github: 'https://github.com/tommycomeau3/WorkoutWizard',
      live: 'https://github.com/tommycomeau3/WorkoutWizard',
      image: '/images/workout-logo.png',
      details: 'Built a web application that uses AI to generate personalized workout routines based on user specifications. Users can input their workout preferences, goals, available equipment, and time constraints to receive a customized routine tailored to their needs.',
      features: ['AI-Generated Workouts', 'User Specifications', 'Customized Routines', 'Interactive Interface', 'Workout Planning'],
    },
  ]
